...
class AndroidReleaseTests(unittest.TestCase):
    ...
    def test_checked_in_specs_separate_current_default_direct_and_historical_versions(self):
        ...
        direct = json.loads((directory / "specs/direct-v5.json").read_text())
        ...
        self.assertEqual(direct["versionCode"], 5)
        self.assertGreater(current["versionCode"], historical["versionCode"])
