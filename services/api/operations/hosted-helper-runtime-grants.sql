-- Apply after migration 014 and general runtime grants. Operator reconciliation uses a separate connection.
...
GRANT UPDATE(state,liability_nano) ON hosted_helper_sessions TO mural_runtime;
...
GRANT UPDATE(provider_attempted_at) ON hosted_sessions TO mural_runtime;
