...
- [ ] Reviewer/tester access works. Listing and consent explicitly describe BYOK costs; unused hosted and purchase features remain unavailable.
...
- [ ] Owner controls for allowance changes and selected/all-user grants are tested with idempotency and audit records. New-trial commitments respect the approved $25 daily and $100 total funding limits; existing grants remain usable.
...
- [ ] Minute packs and final prices are approved, including payment fees and taxes. Play and Stripe sandbox purchase/refund/replay/pending/cancel/recovery cases pass. Authorized controlled live payment/refund evidence is recorded before broad activation.
...
| Launch audience / countries | Supported ages and initial markets, consistent with safety and billing coverage |
| Commerce | Approved minute packs, channel pricing and the budget for controlled live purchase/refund tests |
