...
Practise Norwegian Bokmål, Spanish from Spain, international English or French from France. Your conversations and learning records stay in the app on your device. You can export a backup and import it on another installation.
...
Try Mural, a voice conversation app for language practice. The beta includes Norwegian, Spanish, English and French, meaning subtitles, everyday themes, vocabulary recall bars and local learning backups. This build uses your own OpenAI project key and bills API usage to that project. An internet connection is required.
